...
// inline uint64_t ClockAndTime::getSystem_mS()
// {
//     return mili_seconds_;
// }

// uint32_t HAL_GetTick(void) 
// {
//     return ClockAndTime::getSystem_mS();
// }
...
*/
__attribute__((optimize(0))) void soft_delay_ms (uint32_t dly)
{
    int x =0 ;
    int SystemCoreClock = 160000000;
